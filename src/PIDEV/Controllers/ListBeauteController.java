 ...
 * @author Emir
 */
public class ListBeauteController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        for ( Etablissement d : data) {
            ...
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("../Views/DivListBeaute.fxml"));
                Parent root = (Pane) loader.load();
                DivListBeauteController DHC = loader.getController();
                DHC.LoadValues(d);
    ...
    private void RechercheDynamique(KeyEvent event) {
        ...
        for ( Etablissement d : filteredData) {
            ...
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("../Views/DivListBeaute.fxml"));
                Parent root = (Pane) loader.load();
               DivListCultureController DHC = loader.getController();
                DHC.LoadValues(d);
                ...
                Logger.getLogger(ListCultureController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        c.setPrefColumns(3);
        c.setPadding(new javafx.geometry.Insets(0));
    ...
    private void openmap(MouseEvent event) throws IOException {
        ...
        stage.setTitle("Liste Des Etablissements");
    ...
    public void affichetrie(String scvalue, URL url, ResourceBundle rb, String trisq) throws SQLException {
        ...
        data = le.ListBeauteTrie(scvalue, trisq);
        TilePane b = new TilePane();
        b.setPadding(new javafx.geometry.Insets(30));
        TilePane c = new TilePane();
         ...
         for ( Etablissement d : data) {
            ...
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("../Views/DivListCulture.fxml"));
                Parent root = (Pane) loader.load();
                DivListCultureController DHC = loader.getController();
     ...
     public void trix(String trisq, URL url, ResourceBundle rb) {
        ...
        ListEtablissement le = new ListEtablissement();
        data = le.TriserviceBeaute(trisq);
        TilePane b = new TilePane();
        b.setPadding(new javafx.geometry.Insets(30));
        TilePane c = new TilePane();
