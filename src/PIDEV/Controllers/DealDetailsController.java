...
public class DealDetailsController implements Initializable {
    ...
    public void DealProfil(int id) throws SQLException {
        ...
        if (rating.getChildren().isEmpty()) {
            Label a = new Label("Noter");
            rating.getChildren().add(a);
        }
    ...
    public void rateme(int id) {
        try {
            JFXDialogLayout dialogLayout = new JFXDialogLayout();
            Text title = new Text("Nouvelle évaluation");
            dialogLayout.setHeading(title);
            FXMLLoader loade = new FXMLLoader(getClass().getResource("../Views/RateMe.fxml"));
            ...
            JFXButton addBtn = new JFXButton("Evaluer");
            ...
            addBtn.setOnMouseClicked(new EventHandler<MouseEvent>() {
                ...
                public void handle(MouseEvent event) {
                    try {
                        DealDetailsService DDS = new DealDetailsService();
                        RateMeController RMC = loade.getController();
                        DDS.addnote(id, RMC.geti());
                        DDS.updaterating(id);
                        dialog.close();
