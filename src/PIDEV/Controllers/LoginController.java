...
//                        stage1.show();
                            FirstFrame.user = u;
                            myCroud.id_user=u.getId();
                            System.out.println(u.getRole()+"aaaaaaaaaaaaaaaaaaaaaaaa");
                            if(u.getRole().equals("pro")){
                            FXMLLoader loader =  new FXMLLoader(getClass().getResource("../Views/AffichageTheme.fxml"));
                            Parent root = loader.load();
                            ...
                            Stage pr=(Stage) login.getScene().getWindow();
                             pr.close();}
                                  ...
                                  Parent tableViewParent = FXMLLoader.load(getClass().getResource("../Views/HomePage.fxml"));
