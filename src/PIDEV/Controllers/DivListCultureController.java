 ...
 * @author Emir
 */
public class DivListCultureController implements Initializable {
    ...
    public void doubleclick(MouseEvent event, Etablissement selectedetab) {
        if (event.getClickCount() == 2) {
            try {
                ...
                ProfilCultureController DDC = loader.getController();
                ...
                Logger.getLogger(DivListCultureController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
