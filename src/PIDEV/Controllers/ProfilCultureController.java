 ...
 * @author Emir
 */
public class ProfilCultureController implements Initializable {
    ...
    public void RestoProfil(int id) throws SQLException {
        ...
        Etablissement etab = s.ListCulture().filtered(e -> e.getId() == id).get(0);
...
//
//                Optional<ButtonType> resultmap = alert1.showAndWait();
...
//        scroll.getChildren().add(fp);
        ...
        for (Review d : listreview) {
            ...
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("../Views/DivReviewCulture.fxml"));
                Parent root = (Pane) loader.load();
                DivReviewCultureController DHC = loader.getController();
                DHC.LoadValues(d, e);
