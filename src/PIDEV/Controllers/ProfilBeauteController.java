 ...
 * @author Emir
 */
public class ProfilBeauteController implements Initializable {
...
//        scroll.getChildren().add(fp);
        ...
        for (Review d : listreview) {
            ...
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("../Views/DivReviewBeaute.fxml"));
                Parent root = (Pane) loader.load();
                DivReviewBeauteController DHC = loader.getController();
                DHC.LoadValues(d, e);
