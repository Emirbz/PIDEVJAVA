...
public class EditProfileController implements Initializable {
    ...
    private void editUser(ActionEvent event) {
        ...
        pauseTransition.setOnFinished(ev -> {
            ...
            User user = new User(username.getText(), email.getText(), FirstFrame.user.getPassword(), name.getText(), surname.getText(), phone.getText(), facebook.getText(), address.getText(), nameImage,roleUser);
