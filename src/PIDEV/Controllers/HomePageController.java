...
public class HomePageController implements Initializable {
    ...
    private AnchorPane accueil, profilUser;
    private Button test;
    @FXML
...
//                            iconCon.getScene().setRoot(root);
    ...
    private void AjoutRestaurant(MouseEvent event) throws IOException {
        AnchorPane addRestaurant = FXMLLoader.load(getClass().getResource("../Views/AjoutResto.fxml"));
        setNode(addRestaurant);
    }

    @FXML
    private void ListRestaurant(MouseEvent event) throws IOException {
        AnchorPane listRestaurant = FXMLLoader.load(getClass().getResource("../Views/ListResto.fxml"));
        setNode(listRestaurant);
    }

    @FXML
    private void ListDeals(MouseEvent event) throws IOException {
        AnchorPane listdeals = FXMLLoader.load(getClass().getResource("../Views/ListDeals.fxml"));
        setNode(listdeals);
    }

    @FXML
    private void AjoutDeal(MouseEvent event) throws IOException {
        AnchorPane ajoutdeal = FXMLLoader.load(getClass().getResource("../Views/AddDeal.fxml"));
        setNode(ajoutdeal);
    }

    @FXML
    private void AjoutArticle(ActionEvent event) throws IOException {
        AnchorPane ajoutdeal = FXMLLoader.load(getClass().getResource("../Views/AjouterArticle.fxml"));
        setNode(ajoutdeal);
    }

    @FXML
    private void ListTheme(ActionEvent event) throws IOException {
        AnchorPane listdeals = FXMLLoader.load(getClass().getResource("../Views/Theme.fxml"));
        setNode(listdeals);
    }
